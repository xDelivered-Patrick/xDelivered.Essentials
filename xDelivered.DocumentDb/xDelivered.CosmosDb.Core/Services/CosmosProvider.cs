...
namespace xDelivered.CosmosDb.Core.Services
{
    public class CosmosProvider : ICosmosDbProvider
    {
        ...
        DocumentClient ICosmosDbProvider.Client => Client;
        ...
        public IQueryable<T> Query<T>() where T : IDatabaseModelBase
        {
